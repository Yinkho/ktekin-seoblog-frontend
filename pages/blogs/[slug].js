...
const SingleBlog = ({ blog, query }) => {
    ...
    const head = () => (
        <Head>
            ...
            <meta property="og:image:secure_url" content={`${DOMAIN}/static/images/seo.jpg`} />
            ...
            <Layout>
                <main>
                    <article>
                            ...
                            <section>
                                <div className="container">
                                    ...
                                    <p className="lead mt-3 mark">
                                        Rédigé par <Link href={`/profile/${blog.postedBy.username}`}><a>{blog.postedBy.name}</a></Link> | Published {moment(blog.updatedAt).fromNow()}
                                    </p>
                        ...
                        <div className="container">
                            <section>
                                <h4 className="text-center pt-5 pb-5 h2">Articles similaires</h4>
                                <hr />
                                <div className="row">
                                    {showRelatedBlogs()}
                                </div>
